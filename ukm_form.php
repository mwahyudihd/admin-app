        ...
        <div class="w-full h-full overflow-auto">
            ...
            <div :class="{'ml-0': !sidebarOpen, 'ml-4': sidebarOpen}" class="flex-1 p-6 bg-gray-50 overflow-auto transition-all">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold">Tambahkan UKM</h1>
                </div>
                <div class="bg-white p-4 rounded shadow-md">
                <form class="grid grid-cols-2 gap-6" action="controllers/c_add_ukm.php" method="post" enctype="multipart/form-data">
                    <div>
                    ...
                    <div>
                        <a href='data_ukm.php' class="w-full p-2 border rounded bg-green-500 text-white flex items-center justify-center cursor-pointer">Kembali</a>
                    </div>
                </form>
